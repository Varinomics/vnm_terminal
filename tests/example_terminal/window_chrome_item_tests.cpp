...
class Recording_window_chrome final : public chrome::Example_window_chrome
{
public:
    using chrome::Example_window_chrome::Example_window_chrome;
...
class Exposed_window_chrome final : public chrome::Example_window_chrome
{
public:
    using chrome::Example_window_chrome::Example_window_chrome;
...
void size_titlebar(chrome::Example_window_chrome& titlebar, qreal width = 360.0)
{
...
{
    const QIcon app_icon(QStringLiteral(":/vnm_terminal_example_terminal/vnm_terminal.ico"));
...
bool test_button_hit_regions()
{
    ...
    chrome::Example_window_chrome narrow_titlebar;
