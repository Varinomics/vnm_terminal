...
configure_with_chrome("1.3.1" older_provider_result older_provider_log)
if(older_provider_result EQUAL 0)
    message(FATAL_ERROR "vnm_terminal accepted vnm_qml_chrome 1.3.1")
endif()
string(REGEX REPLACE "[\r\n\t ]+" " " older_provider_log "${older_provider_log}")
if(NOT older_provider_log MATCHES "older than the required minimum 1\\.4")
    message(FATAL_ERROR
        "Older-provider rejection did not name the required 1.4 floor:\n"
        "${older_provider_log}")
endif()

configure_with_chrome("1.4.0" minimum_provider_result minimum_provider_log)
if(NOT minimum_provider_result EQUAL 0)
    message(FATAL_ERROR
        "vnm_terminal rejected vnm_qml_chrome 1.4.0:\n"
