...
:
    ...
    m_app_icon(QStringLiteral(":/vnm_terminal/vnm_terminal.ico"))
{
...
QString chrome::Terminal_window_chrome::terminal_icon_name() const
{
    return m_terminal_icon_name;
}

bool chrome::Terminal_window_chrome::window_active() const
{
    return m_window_active;
}

bool chrome::Terminal_window_chrome::window_maximized() const
{
    return m_window_maximized;
}

void chrome::Terminal_window_chrome::set_terminal_title(const QString& terminal_title)
{
...
void chrome::Terminal_window_chrome::set_terminal_icon_name(const QString& terminal_icon_name)
{
...
void chrome::Terminal_window_chrome::set_window_active(bool active)
{
...
void chrome::Terminal_window_chrome::set_window_maximized(bool maximized)
{
...
chrome::Window_chrome_button_states chrome::Terminal_window_chrome::button_states() const
{
...
chrome::Window_chrome_layout chrome::Terminal_window_chrome::chrome_layout() const
{
...
std::optional<chrome::Window_chrome_button_role> chrome::Terminal_window_chrome::button_role_at(
...
bool chrome::Terminal_window_chrome::is_draggable_titlebar_point(const QPointF& point) const
{
    return item_rect(*this).contains(point) && !button_role_at(point).has_value();
}

chrome::Window_chrome_command chrome::Terminal_window_chrome::command_for_button(
...
chrome::Window_chrome_command chrome::Terminal_window_chrome::button_command_at(
    const QPointF& point) const
{
...
chrome::Window_chrome_command chrome::Terminal_window_chrome::titlebar_double_click_command_at(
    const QPointF& point) const
{
...
void chrome::Terminal_window_chrome::paint(QPainter* painter)
{
    if (painter == nullptr) {
        return;
    }
...
void chrome::Terminal_window_chrome::geometryChange(
...
void chrome::Terminal_window_chrome::hoverMoveEvent(QHoverEvent* event)
{
    set_hovered_button(button_role_at(event->position()));
    QQuickPaintedItem::hoverMoveEvent(event);
}

void chrome::Terminal_window_chrome::hoverLeaveEvent(QHoverEvent* event)
{
    set_hovered_button(std::nullopt);
    QQuickPaintedItem::hoverLeaveEvent(event);
}

void chrome::Terminal_window_chrome::mousePressEvent(QMouseEvent* event)
{
...
void chrome::Terminal_window_chrome::mouseMoveEvent(QMouseEvent* event)
{
    set_hovered_button(button_role_at(event->position()));
    QQuickPaintedItem::mouseMoveEvent(event);
}

void chrome::Terminal_window_chrome::mouseReleaseEvent(QMouseEvent* event)
{
...
void chrome::Terminal_window_chrome::mouseUngrabEvent()
{
    set_pressed_button(std::nullopt);
    QQuickPaintedItem::mouseUngrabEvent();
}

void chrome::Terminal_window_chrome::set_hovered_button(
...
void chrome::Terminal_window_chrome::set_pressed_button(
    std::optional<Window_chrome_button_role> role)
{
...
void chrome::Terminal_window_chrome::invoke_window_command(Window_chrome_command command)
{
